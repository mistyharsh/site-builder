...
export type ContextResolver<C = any, E extends Env = any, P extends string = any, I extends Input = {}> = (
  // eslint-enable-next-line @typescript-eslint/no-explicit-any
  ctx: Context<E, P, I>
) => Promise<C> | C;

// eslint-disable-next-line @typescript-eslint/no-explicit-any
type Options<E extends Env = any, P extends string = any, I extends Input = {}, C = any> = {
  // eslint-enable-next-line @typescript-eslint/no-explicit-any
  schema: GraphQLSchema
  rootResolver?: RootResolver<E, P, I>
  contextResolver?: ContextResolver<C>
  pretty?: boolean
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const graphqlServer = <E extends Env = any, P extends string = any, I extends Input = {}, GQLContext = any>(
  // eslint-enable-next-line @typescript-eslint/no-explicit-any
  options: Options<E, P, I, GQLContext>
) => {
  ...
  return async (c: Context<E, P, I>) => {
    ...
    const { rootResolver, contextResolver } = options
    ...
    try {
      result = await execute({
        ...
        contextValue: contextResolver ? await contextResolver(c) : null,
